...
const ALIASES: ReadonlyMap<string, string> = new Map([
  // ── Trigger ──
  ['start', 'trigger_manual'], ['manualtrigger', 'trigger_manual'], ['manual', 'trigger_manual'],
  ['cron', 'trigger_cron'], ['scheduletrigger', 'trigger_cron'], ['schedule', 'trigger_cron'],
  ['webhook', 'trigger_webhook'],
  ['formtrigger', 'trigger_form'], ['form', 'trigger_form'],
  // ── Code (DEFAULT JavaScript, come n8n; Python solo se esplicito) ──
  ['code', 'action_run_js'], ['codenode', 'action_run_js'],
  ['function', 'action_run_js'], ['functionitem', 'action_run_js'],
  ['runjs', 'action_run_js'], ['runjavascript', 'action_run_js'], ['javascript', 'action_run_js'], ['js', 'action_run_js'],
  ['runpython', 'action_run_python'], ['python', 'action_run_python'], ['py', 'action_run_python'],
  // ── HTTP / fetch ──
  ['httprequest', 'action_http'], ['http', 'action_http'], ['fetch', 'action_http'],
  // ── Set / transform ──
  ['set', 'logic_transform'], ['editfields', 'logic_transform'], ['edit', 'logic_transform'], ['transform', 'logic_transform'],
  // ── Logic ──
  ['if', 'logic_if'], ['filter', 'logic_if'],
  ['switch', 'logic_switch'],
  ['merge', 'logic_merge'], ['flowmerge', 'logic_merge'], ['join', 'logic_merge'],
  ['wait', 'logic_wait'],
  ['splitinbatches', 'logic_loop'], ['loop', 'logic_loop'], ['splitout', 'logic_loop'],
  // ── Email ──
  ['emailsend', 'action_send_email'], ['gmail', 'action_send_email'], ['email', 'action_send_email'], ['sendemail', 'action_send_email'],
  // ── AI / LLM (nodo LLM reale, NON fallback HTTP) ──
  ['openai', 'action_llm_complete'], ['anthropic', 'action_llm_complete'],
  ['llm', 'action_llm_complete'], ['llmchain', 'action_llm_complete'], ['chatopenai', 'action_llm_complete'],
  // ── Community (vendor reali nel catalog) ──
  ['slack', 'community_slack'], ['discord', 'community_discord'], ['github', 'community_github'],
  ['notion', 'community_notion'], ['telegram', 'community_telegram'],
]);
