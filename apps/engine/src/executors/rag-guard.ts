/**
 * RAG security guard — re-export del pacchetto condiviso @flowforge/rag-guard.
 *
 * L'implementazione (scanForInjection, frameRagContent, frameRagResults,
 * RAG_SYSTEM_REINFORCEMENT) vive in `packages/flowforge/rag-guard` perché è
 * usata sia qui (executor rag_search) sia dal nodo agent (@flowforge/nodes-ai-agents):
