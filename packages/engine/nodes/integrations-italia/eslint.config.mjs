...
/**
 * Gate eslint per @medea/engine-nodes-integrations-italia (prima ASSENTE — wirato per la regola "GATE VERDE,
...
export default [
  ...baseConfig,
  {
    // I .js/.cjs in src sono build-helper / transport CJS: non type-aware-lintabili.
    ignores: ['dist', 'node_modules', 'coverage', '**/*.config.*', 'src/**/*.js', 'src/**/*.cjs'],
  },
  {
    files: ['src/**/*.ts'],
    languageOptions: {
