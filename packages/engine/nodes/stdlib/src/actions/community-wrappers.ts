  ...
  def: {
    ...
    configFields: [
      ...
      },
      {
        ...
        type: 'expression',
        required: true,
        help: 'Plain text o mrkdwn Slack.',
      },
      {
        key: 'blocks',
        ...
        language: 'json',
        required: false,
        help: 'Array di blocks per layout ricchi.',
      },
      {
        key: 'threadTs',
        ...
        type: 'expression',
        required: false,
        help: 'Reply a messaggio esistente.',
      },
      {
        key: 'unfurlLinks',
    ...
    outputContract: {
      notes: '`ts` e` il marcatore temporale del messaggio, ed e` cio` che serve per rispondere nel thread o per modificarlo: senza, non si puo` fare ne` l\'uno ne` l\'altro.',
      fields: [
  ...
  def: {
    ...
    configFields: [
      ...
      },
      {
        ...
        type: 'expression',
        required: true,
        help: 'Numeric ID o @username pubblico.',
      },
      {
        key: 'text',
        label: 'Testo (o caption)',
        type: 'expression',
        required: false,
        help: 'Required se photoUrl vuoto.',
      },
      {
        key: 'photoUrl',
        ...
        type: 'expression',
        required: false,
        help: 'Se valorizzato usa sendPhoto.',
      },
      {
        key: 'parseMode',
        label: 'Formato parse',
    ...
    outputContract: {
      ...
      fields: [
        ...
        { name: 'messageId', type: 'number', desc: 'Il messaggio creato: serve per rispondergli o modificarlo.' },
...
export const communityLinearNode: NodeModule = {
  def: {
    ...
    outputContract: {
      notes: '`identifier` e` il codice leggibile della segnalazione — quello che si scrive nei messaggi — mentre `issueId` e` l\'identificativo interno di Linear: sono due cose diverse ed e` facile scambiarle.',
      fields: [
