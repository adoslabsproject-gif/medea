    ...
    configFields: [
      {
        ...
        help:
          'Default null = usa la default integration Slack del tenant. ' +
      ...
      },
      {
        ...
        help:
          'Testo plain o markdown Slack (mrkdwn). Emoji shortcut supportati (:tada:, :rocket:). ' +
      ...
      },
      {
        ...
        help:
          'Array di Block Kit blocks. Quando popolato, sovrascrive il render del campo "text" ' +
