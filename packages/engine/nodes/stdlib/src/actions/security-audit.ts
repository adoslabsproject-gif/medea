...
export const securityAuditNode: NodeModule = {
  def: {
    ...
    outputContract: {
      notes: 'Controlla la configurazione PUBBLICA di un dominio — record di posta, certificato, intestazioni: non entra da nessuna parte. Un punteggio alto non e` un attestato di sicurezza, e` l\'assenza di problemi visibili da fuori.',
      fields: [
        { name: 'domain', type: 'string', desc: 'Il dominio esaminato.' },
        { name: 'score', type: 'number', desc: 'Il punteggio complessivo.' },
        { name: 'findings', type: 'array', desc: 'I rilievi, con gravita` e spiegazione.' },
        { name: 'spf', type: 'object', desc: 'L\'esito del controllo SPF.' },
        { name: 'dkim', type: 'object', desc: 'L\'esito del controllo DKIM.' },
        { name: 'dmarc', type: 'object', desc: 'L\'esito del controllo DMARC.' },
        { name: 'ssl', type: 'object', desc: 'Lo stato del certificato: emittente e scadenza.' },
        { name: 'redirects', type: 'array', desc: 'I reindirizzamenti incontrati partendo dal dominio.' },
        { name: 'headers', type: 'object', desc: 'Le intestazioni di sicurezza trovate e quelle mancanti.' },
        { name: 'checkedAt', type: 'string', desc: 'Quando e` stato fatto il controllo, in ISO 8601.' },
      ],
    },
    vendor: 'flowforge',
    version: '1.0.0',
