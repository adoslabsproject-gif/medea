...
export const odooRpcNodeDef: NodeDef = {
  ...
  configFields: [
    ...
    },
    {
      ...
      help: 'Database name (database_show=False richiede di inserirlo a mano). ' +
    ...
    },
    {
      ...
      help: 'Email o username Odoo. Per workflow automatici crea un utente dedicato ' +
    ...
    },
    {
      ...
      type: 'secret',
      required: true,
      help: 'PER PRODUZIONE: usa un API Key (Odoo 14+, menu utente → Account Security → ' +
    ...
    // ────────── Operation selector ──────────
    {
      ...
      help: 'search_read = leggi record (SELECT). ' +
    ...
    },
    {
      ...
      help: 'Nome tecnico del modello Odoo (lowercase con punti). ' +
    ...
    // ────────── search_read ──────────
    {
      ...
      help: 'Array di triple [campo, operatore, valore] in formato Odoo domain. ' +
    ...
    // ────────── create / write ──────────
    {
      ...
      language: 'json',
      required: false,
      placeholder: '{"name": "Mario Rossi", "email": "mario@example.it", "phone": "+39 333 1234567"}',
      help: 'Oggetto JSON con i campi da scrivere. ' +
    ...
    // ────────── write / unlink ──────────
    {
      ...
      help: 'Array di ID numerici dei record da modificare o cancellare. ' +
    ...
    // ────────── call_method ──────────
    {
      ...
      help: 'Nome del metodo da chiamare sul modello. ' +
    ...
    },
    {
      ...
      help: 'Array JSON dei posizionali. Primo elemento spesso e` l\'array di IDs target. ' +
