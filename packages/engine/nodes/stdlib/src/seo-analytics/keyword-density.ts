...
const STOP_IT = new Set([
  ...
  'un', 'una', 'uno', 'e', 'ed', 'o', 'ma', 'che', 'non', 'è', 'sono', 'sei', 'siamo', 'sei',
  'come', 'più', 'questo', 'questi', 'queste', 'quello', 'quelli', 'quelle', 'al', 'allo',
  'alla', 'agli', 'alle', 'del', 'dello', 'della', 'dei', 'degli', 'delle', 'dal', 'dalla',
  'dai', 'dalle', 'nel', 'nello', 'nella', 'nei', 'negli', 'nelle', 'sul', 'sullo', 'sulla',
  'sui', 'sugli', 'sulle', 'cui', 'mi', 'ti', 'si', 'ci', 'vi', 'se', 'lui', 'lei', 'loro',
  'io', 'tu', 'noi', 'voi', 'ha', 'hai', 'ho', 'abbiamo', 'avete', 'hanno', 'molto', 'poco',
  'troppo', 'già', 'ancora', 'sempre', 'mai', 'anche', 'invece', 'quindi', 'perché', 'però',
  'cosa', 'tutto', 'tutti', 'tutte', 'altro', 'altra', 'altri', 'altre', 'suo', 'sua', 'suoi',
  'sue', 'mio', 'mia', 'miei', 'mie', 'tuo', 'tua', 'tuoi', 'tue', 'nostro', 'nostra', 'nostri',
  'nostre', 'vostro', 'vostra', 'vostri', 'vostre', 'fa', 'fare', 'così', 'puoi', 'può',
  'possono', 'essere', 'avere', 'stato', 'stata', 'stati', 'state',
]);

const STOP_EN = new Set([
  'a', 'an', 'and', 'or', 'but', 'if', 'while', 'as', 'because', 'so', 'than', 'that',
  'this', 'these', 'those', 'the', 'is', 'are', 'was', 'were', 'be', 'been', 'being',
  'have', 'has', 'had', 'do', 'does', 'did', 'will', 'would', 'should', 'could', 'can',
  'may', 'might', 'must', 'shall', 'to', 'of', 'in', 'on', 'at', 'by', 'for', 'with',
  'about', 'against', 'between', 'into', 'through', 'during', 'before', 'after', 'above',
  'below', 'from', 'up', 'down', 'out', 'off', 'over', 'under', 'again', 'further',
  'then', 'once', 'i', 'me', 'my', 'we', 'our', 'you', 'your', 'he', 'him', 'his',
  'she', 'her', 'it', 'its', 'they', 'them', 'their', 'what', 'which', 'who', 'whom',
  'when', 'where', 'why', 'how', 'all', 'any', 'each', 'few', 'more', 'most', 'other',
  'some', 'such', 'no', 'not', 'only', 'own', 'same', 'too', 'very', 's', 't', 'just',
]);

// Stoplist essenziali DE / FR / ES (articoli, preposizioni, congiunzioni, pronomi, ausiliari).
const STOP_DE = new Set([
  'der', 'die', 'das', 'den', 'dem', 'des', 'ein', 'eine', 'einen', 'einem', 'einer', 'eines',
  'und', 'oder', 'aber', 'nicht', 'auch', 'als', 'wie', 'wenn', 'dann', 'doch', 'noch', 'schon',
  'ist', 'sind', 'war', 'waren', 'sein', 'haben', 'hat', 'hatte', 'werden', 'wird', 'wurde',
  'ich', 'du', 'er', 'sie', 'es', 'wir', 'ihr', 'mich', 'dich', 'sich', 'uns', 'euch',
  'in', 'an', 'auf', 'zu', 'mit', 'von', 'bei', 'aus', 'nach', 'über', 'unter', 'für', 'ohne',
  'im', 'am', 'zum', 'zur', 'vom', 'beim', 'dass', 'man', 'nur', 'sehr', 'mehr', 'so',
]);
const STOP_FR = new Set([
  'le', 'la', 'les', 'un', 'une', 'des', 'du', 'de', 'au', 'aux', 'et', 'ou', 'mais', 'donc',
  'ne', 'pas', 'plus', 'que', 'qui', 'quoi', 'dont', 'où', 'ce', 'cette', 'ces', 'cet',
  'je', 'tu', 'il', 'elle', 'nous', 'vous', 'ils', 'elles', 'on', 'me', 'te', 'se', 'lui', 'leur',
  'est', 'sont', 'était', 'être', 'avoir', 'a', 'ont', 'avait', 'fait', 'faire',
  'dans', 'sur', 'sous', 'pour', 'par', 'avec', 'sans', 'entre', 'vers', 'chez', 'comme',
  'son', 'sa', 'ses', 'mon', 'ma', 'mes', 'ton', 'ta', 'tes', 'notre', 'votre', 'leurs', 'très',
]);
const STOP_ES = new Set([
  'el', 'la', 'los', 'las', 'un', 'una', 'unos', 'unas', 'de', 'del', 'al', 'y', 'o', 'pero',
  'no', 'sí', 'que', 'qué', 'quien', 'como', 'cuando', 'donde', 'porque', 'si', 'más', 'muy',
  'yo', 'tú', 'él', 'ella', 'nosotros', 'vosotros', 'ellos', 'ellas', 'me', 'te', 'se', 'le', 'les',
  'es', 'son', 'era', 'ser', 'estar', 'está', 'están', 'haber', 'ha', 'han', 'hay', 'fue',
  'en', 'con', 'por', 'para', 'sin', 'sobre', 'entre', 'hasta', 'desde', 'hacia',
  'su', 'sus', 'mi', 'mis', 'tu', 'tus', 'este', 'esta', 'estos', 'estas', 'ese', 'esa', 'lo',
]);

const STOPLISTS: Record<string, Set<string>> = { it: STOP_IT, en: STOP_EN, de: STOP_DE, fr: STOP_FR, es: STOP_ES };
...
function tokenize(text: string, stripAccents = false): string[] {
  let norm = text.toLowerCase().normalize('NFC').replace(/[‘’“”]/gu, "'");
...
function countNgrams(tokens: string[], n: number, stop: Set<string>, minLen: number): Map<string, number> {
...
function topK(counts: Map<string, number>, k: number, totalTokens: number): { term: string; count: number; density: number }[] {
...
const executor: NodeExecutor = async (config, input, _context) => {   
  ...
  if (!raw.trim()) {
    return { output: { totalTokens: 0, warnings: ['Empty input'] }, durationMs: Date.now() - start, warnings: ['Empty input'] };
  }
  ...
  if (targetRaw) {
    ...
    for (const tgt of targets) {
      ...
      const re = new RegExp(`(?:^|\\s)${tgtTokens.map((t) => t.replace(/[.*+?^${}()|[\]\\]/gu, '\\$&')).join('\\s+')}(?=\\s|$)`, 'gu');
...
export const keywordDensityNode: NodeModule = {
  def: {
    ...
    outputs: ['totalTokens', 'uniqueTokens', 'stoplistSize', 'lang', 'unigrams', 'bigrams', 'trigrams', 'targetKeywords'],
  },
  executor,
};
